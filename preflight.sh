...
# Set STORAGE_USER and STORAGE_ROOT to default values (yiimp-data and /home/yiimp-data), unless
# we've already got those values from a previous run.
if [ -z "$STORAGE_USER" ]; then
  STORAGE_USER=$([[ -z "$DEFAULT_STORAGE_USER" ]] && echo "yiimp-data" || echo "$DEFAULT_STORAGE_USER")
fi
